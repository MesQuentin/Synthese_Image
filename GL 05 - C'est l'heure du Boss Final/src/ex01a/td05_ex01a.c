...
static const char WINDOW_TITLE[] = "Ceci n'est pas une horloge";
...
int main(int argc, char** argv) 
{
    ...
    while(loop) 
    {
        ...
        glPushMatrix();
            glRotatef(-timeinfo->tm_min * 6 + 90,0,0,1);
            glTranslatef(20, 0, 0);
            glScalef(70, 2,1);
            glColor3f(0,0,0);
            drawSquare(1);
        ...
        glPushMatrix();
            glRotatef(-timeinfo->tm_hour * 6 + 150,0,0,1);
            glTranslatef(12, 0, 0);
            glScalef(50, 3,1);
            glColor3f(0,0,0);
            drawSquare(1);
        ...
        glPushMatrix();
            glRotatef(-timeinfo->tm_sec * 6 + 90,0,0,1);
            glTranslatef(20, 0, 0);
            glScalef(93, 1,1);
            glColor3f(0,0,0);
            drawSquare(1);
